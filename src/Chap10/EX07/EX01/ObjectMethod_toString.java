...
//Object 클래스의 toString 메소드 : 객체를 출력할 때 Object toString() 호출
	// toString() : 패키지명.클래스명@해쉬코드
	// 해쉬 코드 : 객체가 가르키고 있는 힙 메모리의 번지를 해쉬코드로 변환
...
class B{ 		// extends Object
	...
	@Override
	public String toString() { 		// toString()을 재정의 함
		return " a : " + a + ", b : " + b;
	}
}
...
public class ObjectMethod_toString {
	...
	public static void main(String[] args) {
		...
		System.out.println(b); 		// toString() 재정의 해서 객체의 필드의 정보를 출력 .
	}
