...
class B { 		// 외부 클래스 : public이 올 수 없다. default가 생략
...
public class ExternalClass_1 {
	...
	public static void main(String[] args) {
		...
		//필드 접근
//		bb.a = 10; 		// private : 클래스 내부에서만 사용 가능, 오류 발생 : 접근이 불가
		bb.b = 20;		// default : 같은 패키지의 클래스에서 접근을 허용
		bb.c = 30; 		// protected : default 포함 + 다른 패키지의 클래스에서 접근 허용 (상속 관계일 때)
		bb.d = 40;		// public : protected를 포함 + 다른 패키지에서 접근 가능
		
		//메소드 접근
//		bb.print1(); 	// private 		: 오류 발생, 클래스 내부에서만 사용 가능
		bb.print2();	// default
		bb.print3();	// protected
		bb.print4();	// public
