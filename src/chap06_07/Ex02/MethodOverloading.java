...
class B{
	static String name = "BTS"; 		// static 키가 할당이 되면 객체 생성 없이 호출 가능
...
public class MethodOverloading {
	...
	public static void main(String[] args) {
		...
		print1();		// static이 들어가 있고 동일한 클래스에 생성된 메소드는 바로 호출이 가능하다
		print1(3);		// 매개변수가 1개이고 정수 타입의 메소드를 호출
		print1(30.8);	// 매개변수가 1개이고 double 타입의 메소드 호출
		print1(2,5);	// 매개변수가 2개이고 int, int 타입의 메소드 호출
		
	}
	
	// 메소드 오버라이딩 : 메소드 이름은 동일, 매개변수타입, 매개변수의 갯수에 따라 해당 메소드를 호출
	...
	public static void print1 (double a) {  //매개변수가 1, 데이터 타입이 double, 
	...
	*/
	...
	public static void print1(int c, double d) { 		// int, int는 오류 ==> int, double로 바꿔야함
