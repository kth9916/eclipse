...
//		System.out.println(value2);
		...
		int[] value4 = null; 			//참조 자료형은 초기값으로 null(알 수 없는, 비어 있는 상태)을 출력 
		System.out.println(value4);
		
		// 2. Heap 메모리의 초기값 (강제 초기화), Heap에는 참조 자료형의 값이 할당.
		//기본 자료형 배열일 경우? 
			//boolean : false , int,long,byte,short,char : 0, double, float : 0.0
		boolean[] array1 = new boolean[30];		//boolean은 false가 기본 값
