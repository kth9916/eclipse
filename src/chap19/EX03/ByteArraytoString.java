...
public class ByteArraytoString {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] array2 = "땡큐".getBytes(Charset.defaultCharset()); 	// 땡큐 ---> byte로 변환해서 배열에 저장.
		byte[] array3 = "베리".getBytes(Charset.forName("MS949"));
		byte[] array4 = "베리".getBytes("UTF-8"); 			// <<예외처리 필요 : 일반 예외 (컴파일시 예외 발생)>>
		...
		// 3. 한글이 깨어지는 경우 : 내보내는 인코딩 타입과 가져오는 인코딩 타입이 불일치할 경우
		
		String str5 = new String(array3, Charset.forName("UTF-8"));
		String str6 = new String(array4, Charset.forName("UTF-8"));
		String str7 = new String(array4, Charset.forName("MS949"));
