...
// EUCKR - 한국 표준, 한글 표현가능 전체 중 표기 가능한 것만 구성되어 있음. 약 11,000 --> 2200개만 표기, 8000자는 표기 안됨
	// 영문 : 1byte 			<=== UTF-8로 처리
	// 한글 : 2byte
	// 웹페이지로 출력할 때

// MS-949 (ANSI) - Microsoft 사에서 개발한 한글 표기 방식. 11000 모두를 표기할 수 있다, Window OS
	// 영문 : 1byte			<=== UTF-8로 처리
	// 한글 : 2byte

// UTF-8 : 모든 서버 (Web, FTP, Mail .....) , git, Mac, 	<가변 길이>
	// 영문 : 1byte			<=== UTF-8로 처리
	// 한글 : 3byte
...
public class EUCKR_VS_MS949 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] b5 = "봵".getBytes("EUC-KR"); 		// 11,000자 중 2000만 표기, 8000(
		byte[] b6 = "봵".getBytes("MS949");			// 11,000자 모두 처리
		
		System.out.println(b5.length); 		// 2
