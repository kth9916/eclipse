...
public class GenericPrinter <T extends Material> { 		// 다양한 재료로 프린팅 하는 프린터(파우더, 플라스틱, 물)

					// T : 타입제한, Material 하위 클래스만 T 타입에 들어 올 수 있다.
	...
	@Override
		public String toString() {  		// 해당 객체의 toString() 메소드 호출
