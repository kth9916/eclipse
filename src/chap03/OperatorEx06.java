...
public class OperatorEx06 {
	public static void main(String[] args) {
		...
		System.out.println(flags >>> 2 & 1); // 0 : 2번째 비트값이 출력
		System.out.println(flags >>> 3 & 1); // 0 : 3번째 비트값이 출력
		System.out.println(flags >>> 4 & 1); // 0 : 4번째 비트값이 출력
		System.out.println(flags >>> 5 & 1); // 0 : 5번째 비트값이 출력
		System.out.println(flags >>> 6 & 1); // 0 : 6번째 비트값이 출력
		System.out.println(flags >>> 7 & 1); // 0 : 7번째 비트값이 출력
