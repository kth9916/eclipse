...
class Button {
	...
	// 호출하는 곳에서 인터페이스의 onClick() 메소드를 재정의 해서 호출
	interface OnClickListener { 	// InnerInterface , static 생략, Button.OnClickListener : 
...
public class ButtonAPIExample_Difficult {

	public static void main(String[] args) {
		// 개발자 1 : 클릭시 음악재생
		Button button1 = new Button(); 		// button1 객체 생성
		
		// A.B ab = new A.B(){이너 인터페이스 B의 메소드를 구현한 코드};
